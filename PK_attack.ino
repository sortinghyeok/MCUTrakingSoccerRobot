     ...
     if(SigNum == 1)
      {
        if(distance >=7)
        {
          ...
          if (x_loc <= 90 && x_loc != 0) {  //좌회전
            ...
            analogWrite(4, 65); digitalWrite(28, LOW); digitalWrite(29, HIGH);
            analogWrite(5, 65); digitalWrite(30, HIGH); digitalWrite(31, HIGH);
          }
            ...
            analogWrite(5, 55); digitalWrite(30, HIGH); digitalWrite(31, HIGH);
          }
          else if(x_loc == 0)
          {
